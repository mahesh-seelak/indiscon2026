        ...
        <div className="space-y-6">
          <div className="bg-blue-50 p-6 rounded-lg shadow-sm">
            ...
            <p className="mb-4">
              ...
              Subsection in India. The 6th IEEE India Council International Subsection Conference (2026 IEEE INDISCON) is
            ...
            <p>
              With a focus on &quot;Smart and Sustainable Technologies for Society,&quot; 2026 IEEE INDISCON aims to bring together
          ...
          <div className="bg-blue-50 p-6 rounded-lg shadow-sm">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <strong>Notification of Acceptance:</strong> 15-08-2026
              </li>
              {/* <li>
      ...
      {activeTab === "special" && (
        <div className="space-y-6">
          <div className="bg-blue-50 p-6 rounded-lg shadow-sm">
            ...
            <p className="mb-4">
              2026 IEEE INDISCON will consider proposals for special sessions, Industry Sessions, panels, and pre-conference
              workshops/tutorials.
            </p>
          </div>
