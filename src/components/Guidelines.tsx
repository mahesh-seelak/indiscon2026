        ...
        <div className="space-y-6">
          <div className="bg-blue-50 p-6 rounded-lg shadow-sm">
            ...
            <p className="mb-4">
              ...
              Subsection in India. The 6th IEEE India Council International Subsection Conference (IEEE INDISCON 2026) is
            ...
            <p>
              With a focus on &quot;Smart and Sustainable Technologies for Society,&quot; IEEE INDISCON 2026 aims to bring together
      ...
      {activeTab === "special" && (
        <div className="space-y-6">
          <div className="bg-blue-50 p-6 rounded-lg shadow-sm">
            ...
            <p className="mb-4">
              IEEE INDISCON 2026 will consider proposals for special sessions, Industry Sessions, panels, and pre-conference
              workshops/tutorials.
            </p>
          </div>
