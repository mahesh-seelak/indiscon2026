      ...
      <div className="container mx-auto px-4 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Meet the distinguished leaders guiding our IEEE initiatives and
            activities
          </p>
        </div>
        ...
        <div className="mb-24 flex flex-col items-center">
          {patronCommittees.map((committee) => (
            <div
              key={committee.title}
              className="mb-16 animate-fadeUp w-full flex flex-col items-center"
            >
              ...
              <div className="flex flex-wrap justify-center gap-8 w-full max-w-6xl">
                {committee.members.map((member) => (
                  <div
                    key={member.id}
                    className="transition-transform duration-300 hover:-translate-y-2 flex justify-center w-64"
                  >
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-8 w-full max-w-6xl">
                {committee.members.map((member) => (
                  <div
                    key={member.id}
                    className="transition-transform duration-300 hover:-translate-y-2 flex justify-center w-72"
                  >
                    <div className="rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl bg-white border border-gray-200 w-72 min-h-[160px] flex items-center justify-center p-6">
