...
export const otherCommittees: Committee[] = [
...

  {
    ...
    members: [
      ...
      m("Dr. Satya Gupta", "President, VLSI Society","/1688613993566.jfif"),
  ...
  },
  {
    ...
    members: [
      ...
      m("Prof. Manoj Saxena", "Chair, EDS IEEE Delhi Section","/1691237327810.jfif"),
      ...
      m("Prof. Deepti Saxena", "Professor, MNIT Jaipur","/Prof. Deepti Saxena.jfif"),
