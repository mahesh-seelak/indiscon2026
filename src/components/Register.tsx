                ...
                {indianTableData.slice(1).map((row, rowIndex) => (
                  ...
                  >
                    {row.map((cell, cellIndex) => (
                      <td
                        key={cellIndex}
                        className={`p-4 border-b border-blue-100 ${cellIndex === 0
            ...
            <div>
              ...
              <div className="mb-5 text-center">
                <a
                  ...
                  className="inline-block rounded-md bg-red-600 px-6 py-3 text-base font-semibold text-white transition hover:bg-red-700"
                >
                  Registration Link
                </a>
              </div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    Google Form and a hard copy must be deposited at the conference venue.
                  </span>
                </li>
              </ul>
            </div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>
                    ...
                    conference proceedings of 2026 IEEE INDISCON and subsequent submission
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    All correspondence regarding registration for 2026 IEEE INDISCON should
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    2026 IEEE INDISCON, the organizing institute, IEEE India Council, and
