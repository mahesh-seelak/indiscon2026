...
He is highly involved in capacity building, delivering impactful lectures, workshops, andconferences globally. He is a prolific author, with several patents and publications inIEEEInternational Journals, contributing to the academic and scientific community. His work, driven by a passion for societal impact and national advancement, resonates acrosssectors, reflecting his commitment to harnessing technology to address contemporarychallengesand enhance India's global standing in innovation.`,
   ...
   //bio: "",
    ...
    title: `EV integration in Smart Grids: Impacts, Challenges, and Opportunities`,
   // about: `updated soon.`
  },
   
 {
   ...
   //bio: "updated soon",
    ...
    title: `Noncoherent SIMO With ASK for Green Communications`,
   // about: `updated soon.`
  },
   
  {
   ...
   //bio: "updated soon",
    imageUrl: "/arun.jpg",
    title: `Nano Electronics: driving semiconductor innovation.`,
   // about: `updated soon.`
  },
...

  {
    ...
    name: "Dr. Kriti Bhargava",
   //bio: "updated soon",
    imageUrl: "/kriti.jpeg",
    title: `Rethinking energy access for off Grid communitie`,
   // about: `updated soon.`
  },
  ...
  },
  {
   ...
   //bio: "updated soon",
    ...
    title: `Semiconduction Manufacturing - Opportunities and Challenges in India`,
    //about: `updated soon.`
  },
    ...
    
  {
   ...
   //bio: "updated soon",
    imageUrl: "/sudeb.jpg",
    title: `The Semiconductor Device Architecture Redefining Next Generation Computing`,
    //about: `updated soon.`
  },
   {
    id: "21",
   ...
   //bio: "updated soon",
    ...
    title: `Emerging Nano Sensors with AI/ML for Trace-level Molecular Detection`,
    //about: `updated soon.`
  },
  {
    id: "17",
  ...
  },
  {
   ...
   //bio: "updated soon",
    imageUrl: "/rajeev.png",
    title: `Memristor Technology From Theory to Practical Circuits and its Application`,
    //about: `updated soon.`
  },
